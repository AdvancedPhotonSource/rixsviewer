...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_plottarget.setItemText(3, QCoreApplication.translate("MainWindow", u"mmepin1_norm", None))
        self.comboBox_plottarget.setItemText(4, QCoreApplication.translate("MainWindow", u"mmepin2_norm", None))
        self.comboBox_plottarget.setItemText(5, QCoreApplication.translate("MainWindow", u"pseudo_cps", None))
        self.comboBox_plottarget.setItemText(6, QCoreApplication.translate("MainWindow", u"intensity_raw", None))
        self.comboBox_plottarget.setItemText(7, QCoreApplication.translate("MainWindow", u"A", None))
        self.comboBox_plottarget.setItemText(8, QCoreApplication.translate("MainWindow", u"i0", None))
        self.comboBox_plottarget.setItemText(9, QCoreApplication.translate("MainWindow", u"i2", None))
